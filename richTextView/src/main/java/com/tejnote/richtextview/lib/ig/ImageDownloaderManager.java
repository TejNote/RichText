...
import com.tejnote.richtextview.lib.exceptions.ImageDownloadTaskAddFailureException;
import com.tejnote.richtextview.lib.exceptions.ImageLoadCancelledException;
    ...
    private static class Task implements Runnable {
        ...
        public void run() {
			...
			try {
				...
				InputStream inputStream = bitmapStream.getInputStream();
